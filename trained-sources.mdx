---
description: "Learn how to manage text input, document uploads, and website data for training your chatbot."
...
<Steps>
  ...
  <Step title="From the left-hand sidebar, go to Training > Trained Sources." />
...
2. Click the **trash bin icon** (🗑️) under the **Actions** column.

3. Confirm the deletion.

**Note:** Deleting a source removes it permanently from the chatbot's knowledge base.
...
The **Trained Sources** section helps you organize and manage the chatbot’s knowledge. Regularly updating this section ensures that the chatbot remains accurate and relevant in responding to user queries.