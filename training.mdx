...
<Steps>
  <Step title=" In the Training Sources section, select the Text tab." />

  <Step title="Enter a **Knowledge Title** (a short description of the information you are adding)." />

  <Step title="In the text area below, **type or paste** the content you want the chatbot to learn." />

  <Step title="Click **Add Knowledge** to save the text." />
</Steps>
