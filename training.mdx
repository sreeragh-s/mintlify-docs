...
<Steps>
  ...
  <Step title="You will now see the Training Sources section, where you can choose between three training methods:">
    * [**Text Input**](/bizmo-chat/bizmo-chat/editor/main#new-accordion)
...
* Click **Manage Sources** to edit or delete previously added training data.

* Regularly update training sources to ensure the chatbot has **accurate and relevant** responses.

***

## **Conclusion**

By following these steps, you can efficiently train your Bizmo.chat chatbot using text, documents, and website data. Regularly updating training sources ensures improved chatbot accuracy and responsiveness. If you need further assistance, visit the **Docs** or **Support** sections in the left menu.