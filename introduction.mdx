...
<img className="block h-full w-full dark:hidden" src="/images/Playground_light.png" />
<img className="hidden h-full w-full dark:block" src="/images/Playground_dark.png" />
