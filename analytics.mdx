---
title: "Analytics "
description: "Monitor chatbot performance, user interactions, and engagement."
---

The Analytics section in Bizmo.chat provides detailed insights into chatbot interactions, helping users track message activity over different time periods. This section is essential for monitoring engagement, optimizing chatbot performance, and understanding user behavior.

<img className="block w-full dark:hidden" src="/images/Analytics_light.png" />
<img className="hidden w-full dark:block" src="/images/Analytics_dark.png" />
